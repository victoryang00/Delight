...
fn bench_ntz(b: &mut test::Bencher) {
    let TEST = [0, 32, 1, 0, 2, 1, 3, 0, 4, 2, 5, 0, 6, 1, 7, 0,
    ...
    b.iter(|| {
        let n = TEST.len() / 2;
        for i in 0..n {
            assert_eq!(basics_ntz(TEST[2 * i]), TEST[2 * i + 1])
        }
    })
}
...
fn bench_ntz1(b: &mut test::Bencher) {
    ...
    b.iter(|| {
        let n = TEST.len() / 2;
        for i in 0..n {
            assert_eq!(basics_ntz1(TEST[2 * i]), TEST[2 * i + 1])
        }
    })
}
...
fn bench_ntz2(b: &mut test::Bencher) {
    ...
    b.iter(|| {
        let n = TEST.len() / 2;
        for i in 0..n {
            assert_eq!(basics_ntz2(TEST[2 * i]), TEST[2 * i + 1])
        }
    })
}
...
fn bench_ntz3(b: &mut test::Bencher) {
    ...
    b.iter(|| {
        let n = TEST.len() / 2;
        for i in 0..n {
            assert_eq!(basics_ntz3(TEST[2 * i]), TEST[2 * i + 1])
        }
    })
}
...
fn bench_ntz4(b: &mut test::Bencher) {
    ...
    b.iter(|| {
        let n = TEST.len() / 2;
        for i in 0..n {
            assert_eq!(basics_ntz4(TEST[2 * i]), TEST[2 * i + 1])
        }
    })
}
...
fn bench_ntz5_nozero(b: &mut test::Bencher) {
    ...
    b.iter(|| {
        let n = TEST.len() / 2;
        for i in 0..n {
            assert_eq!(basics_ntz5(TEST[2 * i]), TEST[2 * i + 1])
        }
    })
}
...
fn bench_ntz6(b: &mut test::Bencher) {
    ...
    b.iter(|| {
        let n = TEST.len() / 2;
        for i in 0..n {
            assert_eq!(basics_ntz6(TEST[2 * i]), TEST[2 * i + 1])
        }
    })
}
...
fn bench_ntz7_easy(b: &mut test::Bencher) {
    ...
    b.iter(|| {
        let n = TEST.len() / 2;
        for i in 0..n {
            assert_eq!(basics_ntz7(TEST[2 * i] as i32), TEST[2 * i + 1] as i32)
        }
    })
}
...
fn bench_ntz8_easy(b: &mut test::Bencher) {
    ...
    b.iter(|| {
        let n = TEST.len() / 2;
        for i in 0..n {
            assert_eq!(basics_ntz8(TEST[2 * i] as i32), TEST[2 * i + 1] as i32)
        }
    })
}
...
fn bench_ntz9_easy(b: &mut test::Bencher) {
    ...
    b.iter(|| {
        let n = TEST.len() / 2;
        for i in 0..n {
            assert_eq!(basics_ntz9(TEST[2 * i] as i32), TEST[2 * i + 1] as i32)
        }
    })
}
...
fn bench_ntz10_easy(b: &mut test::Bencher) {
    ...
    b.iter(|| {
        let n = TEST.len() / 2;
        for i in 0..n {
            assert_eq!(basics_ntz10(TEST[2 * i] as i32), TEST[2 * i + 1] as i32)
        }
    })
}
...
fn bench_ntz11_easy(b: &mut test::Bencher) {
    ...
    b.iter(|| {
        let n = TEST.len() / 2;
        for i in 0..n {
            assert_eq!(basics_ntz11(TEST[2 * i] as i32), TEST[2 * i + 1] as i32)
        }
    })
}
